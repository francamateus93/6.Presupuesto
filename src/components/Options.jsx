  ...
  return (
      <div className="flex flex-col gap-2 items-end mt-4">
        <div className="flex items-center justify-between gap-2">
          <label htmlFor="pages" className="text-sm cursor-pointer text-cyan-600 hover:font-semibold font-medium" onClick={() => openModal("pages")}>Number of pages</label>
          <button
        ...
        <div className="flex items-center justify-between gap-2">
          <label htmlFor="languages" className="text-sm cursor-pointer hover:font-semibold font-medium text-cyan-600" onClick={() => openModal("languages")}>Number of languages</label>
        <button
            className="px-2 rounded-full"
        ...
        {modalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/70 z-50" onClick={closeModal}>
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-lg w-11/12">
              ...
              <p className="text-sm text-gray-500">Add the number of {modalContent} ​​that your project will have.</p>
              <p className="text-sm text-gray-500 mb-2">The cost of each {modalContent} is <strong>30€</strong>.</p>
            </div>
          </div>
        )}
      </div>
